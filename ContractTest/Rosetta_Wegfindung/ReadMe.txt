========================================================================
    DYNAMIC LINK LIBRARY: Rosetta_Wegfindung-Projektübersicht
========================================================================

Diese Rosetta_Wegfindung-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Rosetta_Wegfindung-Anwendung besteht.


Rosetta_Wegfindung.vcxproj
...
Rosetta_Wegfindung.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Rosetta_Wegfindung.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
